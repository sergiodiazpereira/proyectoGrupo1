...
<html lang="en">
    ...
    <body class="body_rafa">
        ...
        <nav id="nav_crono">
            <button class="azul"><a href="pagina_boton_info.html" target="_blank"><i class="fa-solid fa-info tam-img colorBlanco"></i></a></button>
            <button class="amarillo"><a href="pagina_boton_pistas.html" target="_blank"><i class="fa-regular fa-lightbulb tam-img colorBlanco"></i></a></button>
