            ...
            <div class="modal">
                <div class="modal-header">
                    ...
                    <button id="cerrarModal" class="ico-cerrar" type="button">
                        ...
                        <a href="index.php?c=Galeria&m=cargarPagina"><i class="fa-solid fa-xmark"></i></a>
                    </button>
                </div>
                <div id="not">
                ...
                <div class="modal-footer">
                    ...
                    <button class="aniadir"><a id="enlace-cancelar" href="index.php?c=Galeria&m=cargarPagina">Volver</a></button>
                </div>
            </div>
        </div>
    </body>
